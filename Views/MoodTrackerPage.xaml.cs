...
namespace MoodKitApp.Views
{
    public partial class MoodTrackerPage : ContentPage
    {
        private string _selectedMood = string.Empty;
        private int _rating = 0;
        private List<ImageButton> _starButtons;
        private string? _attachedImageFilePath = null;
        ...
        private async void SaveButton_Clicked(object sender, EventArgs e)
        {
            ...
            // (เสริม) สามารถ Disable ปุ่มและแสดง Indicator ระหว่างบันทึก เพื่อป้องกันการกดซ้ำ
